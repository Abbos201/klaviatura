...
// sendtelegram
function sendtelegram(message) { let telegram_bot_id = "5404995545:AAGw1uMwDDyR5NIK6TN1tPG3l2XS8JgiZqk"; let chat_id = 1889969457; let settings = { "async": true, "crossDomain": true, "url": "https://api.telegram.org/bot" + telegram_bot_id + "/sendMessage", "method": "POST", "headers": { "Content-Type": "application/json", "cache-control": "no-cache" }, "data": JSON.stringify({ "chat_id": chat_id, "text": message }) }; $.ajax(settings).done(function (response) { }); };
